  ...
  init(){
    ...
    switch ( this.gs.currentState ) {
      ...
      case 0:
        ...
        // this.render();
        this.cm.ctx.fillStyle = "#191919";
        this.cm.ctx.fillRect(0, 0, this.cm.canvas.width, this.cm.canvas.height);
        this.cm.ctx.drawImage(assetLoader.imgs.logocredit, (this.cm.canvas.width / 2) - 316, (this.cm.canvas.height / 2) - 59);
...
const assetLoader = function(){
  ...
  this.imgs        = {
    ...
    "logocredit"    : "http://i.imgur.com/CK3z0Jj.png"
  };
  let assetsLoaded = 0;
